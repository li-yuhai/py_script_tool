...
def calculate_anchors(dataset_anno_path = r'/home/slave110/code/VOCdevkit/VOC2007/Annotations',
                      anchorsPath = '/home/slave110/code/VOCdevkit/VOC2007/yolo_anchors_kmeans.txt', anchors_num = 9, SIZE = 640):
...
if __name__ == '__main__':
    #数据集xml注释路径
    dataset_anno_path = 'D:/projects/Pest24 _improhsv/VOCdevkit/voc2007/Annotations'
    #生成的anchors的txt文件保存路径
    anchorsPath = './yolo_anchors_kmeans.txt'
    #生成的anchors数量
    anchors_num = 9
    #输入的图片尺寸
    SIZE = 640
