...
mAP5_1  = df1["metrics/mAP_0.5:0.95"].values.tolist()

epoch_2 = df2["               epoch"].values.tolist()                     #通过文件表头信息读取文件内容
mAP5_2  = df2["metrics/mAP_0.5:0.95"].values.tolist()

epoch_3 = df3["               epoch"].values.tolist()                     #通过文件表头信息读取文件内容
mAP5_3  = df3["metrics/mAP_0.5:0.95"].values.tolist()

epoch_4 = df4["               epoch"].values.tolist()                     #通过文件表头信息读取文件内容
mAP5_4  = df4["metrics/mAP_0.5:0.95"].values.tolist()

epoch_5 = df5["               epoch"].values.tolist()                     #通过文件表头信息读取文件内容
mAP5_5  = df5["metrics/mAP_0.5:0.95"].values.tolist()
...
plt.ylabel('mAP_0.5:0.95', fontsize=14)
