...
if __name__ == '__main__':
    ...
    xml_dir = 'D:/projects/Pest24/VOCdevkit/voc2007/Annotations'
    ...
    # 预先分配好的训练、验证、测试数据集
    train_txt = 'D:/projects/Pest24/VOCdevkit/voc2007/ImageSets/val.txt'
    xml_path = 'D:/projects/Pest24/VOCdevkit/voc2007/Annotations/'
    last_fix = '.xml'
    list_files = open(train_txt).readlines()
    xml_list_train = []
    for file in list_files:
        file = file.strip()
        xml_list_train.append(xml_path + file + last_fix)

    # 对训练数据集对应的xml进行coco转换
    convert(xml_list_train, save_json_test)
    # 对验证数据集的xml进行coco转换
